...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"background/delaunay.js":[function(require,module,exports) {
"use strict";
  ...
  _createClass(Delaunay, [{
    ...
    value: function triangulate() {
      ...
      var _loop = function _loop(i) {
        ...
        if (triangle === undefined) return "break";
...
},{}],"background/moving-triangles.js":[function(require,module,exports) {
"use strict";
...
var main = function () {
  ...
  setupScene(); // Initialize update loop. Locked to specific FPS
  ...
  function drawTriangles(ctx, vertices, triangles, drawEdges) {
    for (var i = 0; i < triangles.length; i++) {
      ...
      var color = getGradientColor(triangleColorGradient[0], triangleColorGradient[1], heightRatio);
      ctx.fillStyle = "rgb(".concat(color.join(), ")");
      ctx.fill();
...
},{"./delaunay":"background/delaunay.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "56316" + '/');
...
},{}]},{},["../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","background/moving-triangles.js"], null)
//# sourceMappingURL=/moving-triangles.f2a0e8a5.js.map